...
def train_evaluate_svm(data, label_encoder):
    ...
    plt.figure()
    plot_confusion_matrix(conf_matrix, classes=['Pneumonia', 'Normal'], title='SVM Binary Classifier Confusion Matrix')
    plt.savefig("E:/confusion_matrix_2Class.png")
    ...
    plt.savefig("E:/roc_curve_2Class.png")
    ...
    #joblib.dump(svm_classifier, "E:/svm_classifier.pkl")
